...
import { Sparkles, Mail, Lock, Eye, EyeOff, Loader2, ArrowRight, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0f0f14] relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-400">Sign in to your AI Utility Hub account</p>
        </div>
